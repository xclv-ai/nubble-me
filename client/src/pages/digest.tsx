    ...
    return (
      <div className="h-screen w-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <p className="text-sm font-medium text-foreground mb-1">No feed available</p>
          <p className="text-xs text-muted-foreground mb-4">Could not load the daily feed.</p>
          <button
            onClick={() => refetch()}
  ...
  if (!feed || !feed.stories || feed.stories.length === 0) {
    return (
      <div className="h-screen w-screen flex items-center justify-center bg-background">
        <div className="text-center">
          <Newspaper className="w-10 h-10 mx-auto mb-4 text-muted-foreground" />
          <p className="text-sm font-medium text-foreground mb-1">Feed not generated yet</p>
